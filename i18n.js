...
var YTCHAT_MESSAGES = {
  ...
  "zh_TW": {
    ...
    "optSwap": "將聊天室移至另一側",
    "optTheater": "在劇院模式停靠聊天室",
    "optTheaterHint": "填補 YouTube 在該處預留的空位。",
    "optDivider": "顯示拖曳分隔線",
    "optDividerHint": "隱藏後版面維持不變，但無法再拖曳調整。",
    ...
    "btnReset": "回復預設值",
    "toastSaved": "已儲存",
    "noteNarrow": "視窗寬度小於 1000 px 時，YouTube 會將聊天室排在影片下方，側邊欄在該情況下不會生效。",
    "linkSource": "原始碼",
  ...
  "zh_CN": {
    ...
    "optSwap": "将聊天移至另一侧",
    "optTheater": "在剧院模式停靠聊天",
    "optTheaterHint": "填补 YouTube 在该处预留的空位。",
    "optDivider": "显示拖动分隔线",
    "optDividerHint": "隐藏后布局维持不变，但无法再拖动调整。",
    ...
    "btnReset": "恢复默认值",
    "toastSaved": "已保存",
    "noteNarrow": "窗口宽度小于 1000 px 时，YouTube 会将聊天排在视频下方，侧边栏在该情况下不会生效。",
    "linkSource": "源代码",
